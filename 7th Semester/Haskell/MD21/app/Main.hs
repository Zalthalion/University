...
main = do
    ...
    let v1_a1 = [1,2,2,1,1,1]
    let v2_a1 = [(1, 987),(2,1),(3,7),(4,7), (5,7)]
    let aa1 = aa v1_a1 v2_a1  -- Rezultāts:[987,1]

    --Testpiemērs, kur skaitlim atbilst vārds
    let v1_a2 = ["1","2","2","2","3","4","5","5","5"]
    let v2_a2 = [("1","ir"),("2","ziema"),("3","un"),("1","ir"),("5","aukstums")]
    let aa2 = aa v1_a2 v2_a2 -- rezultāts: ["ir","ziema","un","aukstums"]

    --Divi testpiemēri:
    --Testpiemērs izmantojot burtus
    let v1_b1 = [("ab", "cd"), ("ef", "gh"), ("ef", "gh"), ("ij", "kl"), ("mn", "op")]
    let v2_b1 = [("cd", "ef"), ("gh", "ef"), ("op", "zzz"), ("i", "ff"), ("kl", "en")]
    let bb1 = bb v1_b1 v2_b1 -- Rezultāts: [("ab","ef"),("ef","ef"),("ij","en"),("mn","zzz")]

    --Testpiemērs izmantojot skaitļus
    let v1_b2 = [(1,2), (3,4), (3,6), (7,8), (9,10)]
    let v2_b2 = [(1,1), (2,2), (4,0), (6,0), (8,555000)]
    let bb2 = bb v1_b2 v2_b2  -- Rezultāts: [(1,2),(3,0),(7,555000)]

    --Divi testpiemēri:
    --Testpiemērs izmantojot ciparus
    let v_c1= [(1,2),(2,3),(2,3),(1,1),(4,5),(5,1)]
    let cc1 = cc v_c1
    --Rezultāts:
    ...
    --Testpiemērs izmantojot burtus
    let v_c2 = [("ab","cd"),("cd","ef"),("gh","ij"),("ij","kl"),("kl","mn")]
    let cc2 = cc v_c2
    --Rezultāts:
